...
# Hello Ahmed
  ...
  def test_function_to_add_friend()
    operation = add_friend(@person2, "John")
  ...
  def test_function_to_delete_friend()
    operation = delete_friend(@person1, "Scooby")
  ...
  def test_find_total_of_people_money()
    ...
    result = find_total_money(@people, variable)
